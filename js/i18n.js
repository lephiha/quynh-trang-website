(() => {
  ...
  const translations = {
    ...
    'Vũ Quỳnh Trang — đồng hành chăm sóc sức khỏe và vóc dáng': 'Vũ Quỳnh Trang — health and wellbeing guidance',
    'Nội dung từ Facebook': 'Facebook content',
    'Giá trị đồng hành': 'How I support you',
    'Những giá trị Quỳnh Trang': 'What Quỳnh Trang',
    'mang đến': 'brings to you',
    'Những giá trị Quỳnh Trang mang đến': 'What Quỳnh Trang brings to you',
    'Mỗi hành trình bắt đầu từ việc hiểu đúng, lựa chọn phù hợp và kiên trì với những thay đổi tích cực mỗi ngày.': 'Every journey begins with clear understanding, the right choices, and consistent positive change each day.',
    'Sức khỏe': 'Well-being',
    'Đồng hành cải thiện vóc dáng, xây dựng thói quen tốt và nâng cao năng lượng mỗi ngày.': 'Support to improve your physique, build healthy habits, and feel more energized each day.',
    'Kiến thức': 'Knowledge',
    'Chia sẻ kiến thức dinh dưỡng khoa học theo cách gần gũi, dễ hiểu và dễ áp dụng.': 'Practical, approachable nutrition knowledge that is easy to understand and apply.',
    'Cơ hội đồng hành': 'Opportunity to grow together',
    'Cùng bạn tìm hiểu mô hình chăm sóc sức khỏe phù hợp với mục tiêu, thời gian và thế mạnh cá nhân.': 'Explore a health-focused model that fits your goals, schedule, and personal strengths.',
    'Phát triển bản thân': 'Personal growth',
    'Từng bước trở nên chủ động, tự tin và tạo ra những thay đổi tích cực trong cuộc sống.': 'Become more proactive and confident while creating positive changes in your life, one step at a time.',
    'Cùng nhau kiến tạo': 'Together, we create',
    'Sức khỏe tốt hơn': 'Better health',
    'Gia đình hạnh phúc hơn': 'Happier families',
    'Cộng đồng tích cực hơn': 'A more positive community',
    'Vì một cộng đồng khỏe mạnh, chủ động và hạnh phúc hơn mỗi ngày.': 'For a healthier, more proactive, and happier community every day.',
    'Trang Chủ': 'Home',
    'Về Tôi': 'About Me',
    'Hành Trình': 'Journeys',
    ...
    'Chuẩn bị yêu cầu đặt lịch →': 'Prepare booking request →',
    'Hoàn tất yêu cầu qua email và Zalo': 'Complete your request by email and Zalo',
    'Thông tin mới được chuẩn bị, chưa tự gửi đi. Hãy hoàn tất cả hai bước dưới đây.': 'Your details are prepared but have not been sent. Please complete both steps below.',
    'Gửi email': 'Send an email',
    'Mở bản nháp đã điền sẵn, kiểm tra rồi bấm Gửi trong ứng dụng email.': 'Open the pre-filled draft, review it, then press Send in your email app.',
    'Mở Gmail →': 'Open Gmail →',
    'Dùng ứng dụng email khác': 'Use another email app',
    'Nhắn qua Zalo': 'Message on Zalo',
    'Sao chép nội dung, mở Zalo của Quỳnh Trang, dán vào cuộc trò chuyện rồi bấm Gửi.': 'Copy the request, open Quỳnh Trang’s Zalo, paste it into the chat, then press Send.',
    'Sao chép nội dung': 'Copy request',
    'Mở Zalo →': 'Open Zalo →',
    'Xem nội dung yêu cầu để sao chép thủ công': 'View request to copy manually',
    'Nội dung yêu cầu đặt lịch': 'Booking request text',
    'Nội dung đã sẵn sàng. Hãy gửi email và tin nhắn Zalo ở hai bước bên dưới.': 'Your request is ready. Send the email and Zalo message using the two steps below.',
    'Đã sao chép nội dung. Hãy mở Zalo, dán và bấm Gửi.': 'Request copied. Open Zalo, paste it, and press Send.',
    'Không thể sao chép tự động. Nội dung đã được chọn; hãy sao chép thủ công rồi dán vào Zalo.': 'Automatic copy is unavailable. The text is selected; copy it manually and paste it into Zalo.',
